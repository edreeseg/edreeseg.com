        ...
        <section className="about-container">
            ...
            <section className="about-synopsis">
                <div className="about-content">
                    ...
                    <p>If anything I've said here is of interest to you, and you want to chat or talk to me about an opportunity, please don't hesitate to reach out.  I know time is valuable, and I promise not to waste yours.</p>
                </div>
                <div className="about-content">
