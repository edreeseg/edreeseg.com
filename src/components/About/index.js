        ...
        <section className="about-container">
            ...
            <section className="about-synopsis">
                <div className="about-content">
                    ...
                    <p>My biggest motivator in life is supporting my wife and three daughters, all of whom give meaning and breathe life into everything I do.  My favorite chess opening is the Evans Gambit, and I prefer open games.  I spent a decade playing the euphonium, and hope to have the time to pick it up again one day.  I'm an 11th-Level Bard with a -3 STR modifier, but I try my best.</p>
